...
exports.ZKConfig = exports.currentDir = exports.CrossChain = void 0;
/*
 ...
 */
exports.CrossChain = __importStar(require("./managed/contract/index.cjs"));
__exportStar(require("./witnesses.js"), exports);
