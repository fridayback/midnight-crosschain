...
import { Wallet, Address } from '@midnight-ntwrk/wallet-api';
...
declare class CrossChainApi {
    ...
    transferOwner(newOwner: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "transferOwner">>;
    acceptOwner(): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "acceptOwner">>;
    updateSmgPk(newVoter: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "updateSmgPk">>;
    setFeeReceiver(feeReceiver: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "setFeeReceiver">>;
    setTokenManager(tokenManager: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "setTokenManager">>;
    setMegerWorker(mergeWorker: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "setMegerWorker">>;
    ...
    addAdmin(admin: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "addAdmin">>;
    removeAdmin(admin: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "removeAdmin">>;
    ...
    setSmgPksks(voters: Address[]): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "setSmgPksks">>;
    ...
    addAdminProposal(addr: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "newProposal">>;
    removeAdminProposal(addr: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "newProposal">>;
    updateFeeReceiverProposal(addr: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "newProposal">>;
    updateTokenManagerProposal(addr: Address): Promise<_midnight_ntwrk_midnight_js_contracts.FinalizedCallTxData<CrossChainContract, "newProposal">>;
