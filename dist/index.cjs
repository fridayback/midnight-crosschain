...
var Contract = class {
          ...
          if (currentProposal_0.pType === 3) {
            ...
            if (currentProposal_0.pType === 4) {
              this._setAdminThreshold_0(
                ...
                ((t1) => {
                  if (t1 > 255n) {
                    throw new __compactRuntime__namespace.CompactError("crosschain.compact line 616 char 23: cast from Field or Uint value to smaller Uint value failed: " + t1 + " is greater than 255");
                  }
                  return t1;
              ...
              if (currentProposal_0.pType === 5) {
                this._setSmgPKThreold_0(
                  ...
                  ((t1) => {
                    if (t1 > 255n) {
                      throw new __compactRuntime__namespace.CompactError("crosschain.compact line 618 char 21: cast from Field or Uint value to smaller Uint value failed: " + t1 + " is greater than 255");
                    }
                    return t1;
                  })(currentProposal_0.threshold)
                );
  ...
  _removeExpiredHisTx_0(context, partialProofData, tx_0) {
    if (_descriptor_2.fromValue(__compactRuntime__namespace.queryLedgerState(
      ...
      ((t1) => {
        if (t1 > 18446744073709551615n) {
          throw new __compactRuntime__namespace.CompactError("crosschain.compact line 643 char 51: cast from Field or Uint value to smaller Uint value failed: " + t1 + " is greater than 18446744073709551615");
        }
        return t1;
      })(_descriptor_1.fromValue(__compactRuntime__namespace.queryLedgerState(
        context,
