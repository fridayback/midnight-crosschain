...
class Contract {
      ...
      transferFeeOfNativeToken: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('transferFeeOfNativeToken',
                                      'argument 1 (as invoked from Typescript)',
                                      'crosschain.compact line 352 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
      ...
      transferOwner: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('transferOwner',
                                      'argument 1 (as invoked from Typescript)',
                                      'crosschain.compact line 393 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
  ...
  _executeCrossProposalOfMappingToken_0(context, partialProofData, uniqueId_0) {
    ...
    const tmp_0 = this._evolveNonce_0(((t1) => {
                                        if (t1 > 18446744073709551615n) {
                                          throw new __compactRuntime.CompactError('crosschain.compact line 342 char 23: cast from field value to Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                                        }
                                        return t1;
                                      })(_descriptor_3.fromValue(Contract._query(context,
                                                                                 partialProofData,
    ...
    this._mintToken_0(context,
                      ...
                      ((t1) => {
                        if (t1 > 18446744073709551615n) {
                          throw new __compactRuntime.CompactError('crosschain.compact line 343 char 29: cast from unsigned value to smaller unsigned value failed: ' + t1 + ' is greater than 18446744073709551615');
                        }
                        return t1;
                      })(proposal_0.amount),
                      _descriptor_1.fromValue(Contract._query(context,
                                      ...
                                      this._left_0(_descriptor_2.fromValue(Contract._query(context,
                                                                                           ...
                                                                                           [
                                                                                            ...
                                                                                            { popeq: { cached: false,
                                                                                                       result: undefined } }]).value)),
                                      feeInfo_0.totalFee);
    if (resultSend_0.change.is_some) {
      this._addTreasuryCoin_0(context,
                              partialProofData,
                              resultSend_0.change.value);
    }
    return [];
  }
  _addTreasuryCoin_0(context, partialProofData, coin_0) {
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 340282366920938463463374607431768211455n) {
                      throw new __compactRuntime.CompactError('crosschain.compact line 373 char 28: cast from field value to Uint value failed: ' + t1 + ' is greater than 340282366920938463463374607431768211455');
                    }
                    return t1;
                  })(_descriptor_3.fromValue(Contract._query(context,
                                                             partialProofData,
  ...
  _getFee_0(context, partialProofData, tokenPairId_0) {
    const tokenPair_0 = _descriptor_11.fromValue(Contract._query(context,
                                                                 ...
                                                                 [
                                                                  ...
                                                                  { popeq: { cached: false,
                                                                             result: undefined } }]).value);
    if (this._equal_4(tokenPair_0.fee, 0n)) {
      let tmp_0;
  ...
  _checkAdminAuthorized_0(context, partialProofData) {
    const isOwner_0 = this._equal_9(_descriptor_2.fromValue(Contract._query(context,
                                                                            partialProofData,
                                                                            [
                                                                             { dup: { n: 0 } },
                                                                             { idx: { cached: false,
    ...
    return isOwner_0
           &&
           this._equal_10(_descriptor_12.fromValue(Contract._query(context,
                                                                   partialProofData,
                                                                   [
                                                                    { dup: { n: 0 } },
                                                                    { idx: { cached: false,
