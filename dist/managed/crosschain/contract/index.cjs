...
class Contract {
    ...
    this.circuits = {
      userLock: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(smgId_0).concat(_descriptor_21.toValue(toAddr_0).concat(_descriptor_0.toValue(tokenPairId_0).concat(_descriptor_16.toValue(coin_0)))),
            alignment: _descriptor_1.alignment().concat(_descriptor_21.alignment().concat(_descriptor_0.alignment().concat(_descriptor_16.alignment())))
          },
          output: undefined,
          publicTranscript: [],
      ...
      smgMint: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('smgMint',
                                      'argument 1 (as invoked from Typescript)',
                                      'crosschain.compact line 275 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        if (!(uniqueId_0.buffer instanceof ArrayBuffer && uniqueId_0.BYTES_PER_ELEMENT === 1 && uniqueId_0.length === 32)) {
      ...
      voteMultiCrossProposal: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('voteMultiCrossProposal',
                                      'argument 1 (as invoked from Typescript)',
                                      'crosschain.compact line 296 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
      ...
      voteCrossProposal: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('voteCrossProposal',
                                      'argument 1 (as invoked from Typescript)',
                                      'crosschain.compact line 304 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        if (!(uniqueId_0.buffer instanceof ArrayBuffer && uniqueId_0.BYTES_PER_ELEMENT === 1 && uniqueId_0.length === 32)) {
      ...
      executeCrossProposalOfNativeToken: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('executeCrossProposalOfNativeToken',
                                      'argument 1 (as invoked from Typescript)',
                                      'crosschain.compact line 331 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        if (!(uniqueId_0.buffer instanceof ArrayBuffer && uniqueId_0.BYTES_PER_ELEMENT === 1 && uniqueId_0.length === 32)) {
      ...
      transferFeeOfNativeToken: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('transferFeeOfNativeToken',
                                      'argument 1 (as invoked from Typescript)',
                                      'crosschain.compact line 366 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
              ...
              coin_0)
  {
    ...
    const tmp_0 = { smgId: smgId_0,
                    ...
                    nonce:
                      ((t1) => {
                        if (t1 > 340282366920938463463374607431768211455n) {
                          throw new __compactRuntime.CompactError('crosschain.compact line 190 char 14: cast from field value to Uint value failed: ' + t1 + ' is greater than 340282366920938463463374607431768211455');
                        }
                        return t1;
              ...
              coin_0)
  {
    ...
    const tmp_0 = { smgId: smgId_0,
                    ...
                    nonce:
                      ((t1) => {
                        if (t1 > 340282366920938463463374607431768211455n) {
                          throw new __compactRuntime.CompactError('crosschain.compact line 264 char 14: cast from field value to Uint value failed: ' + t1 + ' is greater than 340282366920938463463374607431768211455');
                        }
                        return t1;
                      })(_descriptor_3.fromValue(Contract._query(context,
                                                                 partialProofData,
  ...
  _accumulateFee_0(context, partialProofData, isMappingToken_0, token_0, fee_0)
  {
                                                            ...
                                                            result: undefined } }]).value))
    {
      ...
      const tmp_0 = { totalFee:
                        ((t1) => {
                          if (t1 > 340282366920938463463374607431768211455n) {
                            throw new __compactRuntime.CompactError('crosschain.compact line 290 char 111: cast from unsigned value to smaller unsigned value failed: ' + t1 + ' is greater than 340282366920938463463374607431768211455');
                          }
                          return t1;
                        })(accAmount_0),
                      isMappingToken: isMappingToken_0 };
  ...
  _executeCrossProposalOfMappingToken_0(context, partialProofData, uniqueId_0) {
    ...
    const tmp_0 = this._evolveNonce_0(((t1) => {
                                        if (t1 > 18446744073709551615n) {
                                          throw new __compactRuntime.CompactError('crosschain.compact line 356 char 23: cast from field value to Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                                        }
                                        return t1;
                                      })(_descriptor_3.fromValue(Contract._query(context,
                                                                                 partialProofData,
    ...
    this._mintToken_0(context,
                      ...
                      ((t1) => {
                        if (t1 > 18446744073709551615n) {
                          throw new __compactRuntime.CompactError('crosschain.compact line 357 char 29: cast from unsigned value to smaller unsigned value failed: ' + t1 + ' is greater than 18446744073709551615');
                        }
                        return t1;
                      })(proposal_0.amount),
                      _descriptor_1.fromValue(Contract._query(context,
  ...
  _addTreasuryCoin_0(context, partialProofData, coin_0) {
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 340282366920938463463374607431768211455n) {
                      throw new __compactRuntime.CompactError('crosschain.compact line 389 char 28: cast from field value to Uint value failed: ' + t1 + ' is greater than 340282366920938463463374607431768211455');
                    }
                    return t1;
                  })(_descriptor_3.fromValue(Contract._query(context,
                                                             partialProofData,
  ...
  _checkAdminAuthorized_0(context, partialProofData) {
    ...
    return isOwner_0
           &&
           this._equal_14(_descriptor_13.fromValue(Contract._query(context,
                                                                   partialProofData,
                                                                   [
                                                                    { dup: { n: 0 } },
                                                                    { idx: { cached: false,
  ...
  _newProposal_0(context, partialProofData, newProposal_0) {
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('crosschain.compact line 527 char 20: cast from field value to Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
                  })(_descriptor_3.fromValue(Contract._query(context,
                                                             partialProofData,
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('crosschain.compact line 528 char 32: cast from field value to Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
                  })(_descriptor_3.fromValue(Contract._query(context,
                                                             partialProofData,
    ...
    this._voteProposal_0(context,
                         ...
                         ((t1) => {
                           if (t1 > 4294967295n) {
                             throw new __compactRuntime.CompactError('crosschain.compact line 529 char 16: cast from field value to Uint value failed: ' + t1 + ' is greater than 4294967295');
                           }
                           return t1;
                         })(_descriptor_3.fromValue(Contract._query(context,
                                                                    partialProofData,
          ...
          if (currentProposal_0.type === 3) {
            ...
            if (currentProposal_0.type === 4) {
              this._setAdminThreshold_0(context,
                                        ...
                                        ((t1) => {
                                          if (t1 > 255n) {
                                            throw new __compactRuntime.CompactError('crosschain.compact line 557 char 23: cast from unsigned value to smaller unsigned value failed: ' + t1 + ' is greater than 255');
                                          }
                                          return t1;
              ...
              if (currentProposal_0.type === 5) {
                this._setSmgPKThreold_0(context,
                                        ...
                                        ((t1) => {
                                          if (t1 > 255n) {
                                            throw new __compactRuntime.CompactError('crosschain.compact line 559 char 21: cast from unsigned value to smaller unsigned value failed: ' + t1 + ' is greater than 255');
                                          }
                                          return t1;
                                        })(currentProposal_0.threshold));
              } else {
