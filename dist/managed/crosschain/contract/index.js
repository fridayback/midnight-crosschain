...
const _descriptor_13 = new _VoteForCrossPropasal_0();

const _descriptor_14 = new __compactRuntime.CompactTypeVector(5, _descriptor_13);
...
const _descriptor_15 = new _ExecuteCrossProposalInfo_0();

const _descriptor_16 = new __compactRuntime.CompactTypeVector(3, _descriptor_15);
...
export class Contract {
  ...
  _checkAdminAuthorized_0(context, partialProofData) {
    const isOwner_0 = this._equal_10(_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                               partialProofData,
                                                                                               [
                                                                                                { dup: { n: 0 } },
                                                                                                { idx: { cached: false,
    ...
    return isOwner_0
           &&
           this._equal_11(_descriptor_7.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                    partialProofData,
                                                                                    [
                                                                                     { dup: { n: 0 } },
                                                                                     { idx: { cached: false,
  ...
  _removeTokenPair_0(context, partialProofData, tokenPairId_0) {
    __compactRuntime.assert(this._equal_16(_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                     partialProofData,
                                                                                                     [
                                                                                                      { dup: { n: 0 } },
                                                                                                      { idx: { cached: false,
