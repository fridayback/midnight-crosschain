...
const _descriptor_9 = new __compactRuntime.CompactTypeVector(29, _descriptor_5);
...
export class Contract {
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(6n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(feeReceiverInit_0),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_3 = 1n;
                   ...
                   isAdd_0)
  {
    ...
    const oldAmount_0 = _descriptor_6.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                  partialProofData,
                                                                                  [
                                                                                   { dup: { n: 0 } },
                                                                                   { idx: { cached: false,
  ...
  _checkAdminAuthorized_0(context, partialProofData) {
    const isOwner_0 = this._equal_16(_descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                     ...
                                     this._ownPublicKey_0(context,
                                                          partialProofData));
    let t_0, tmp_1, tmp_0;
    const isAdminAuthorized_0 = (tmp_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                   partialProofData,
                                                                                                   [
                                                                                                    { dup: { n: 0 } },
                                                                                                    { idx: { cached: false,
                                 ...
                                 _descriptor_6.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                           ...
                                                                                           [
                                                                                            ...
                                                                                            { popeq: { cached: true,
                                                                                                       result: undefined } }]).value))
                                &&
                                (t_0 = (tmp_1 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                          partialProofData,
                                                                                                          [
                                                                                                           { dup: { n: 0 } },
                                                                                                           { idx: { cached: false,
  ...
  return {
    ...
    proposals: {
      ...
      [Symbol.iterator](...args_0) {
        ...
        return self_0.asMap().keys().map(  (key) => {    const value = self_0.asMap().get(key).asCell();    return [      _descriptor_2.fromValue(key.value),      _descriptor_26.fromValue(value.value)    ];  })[Symbol.iterator]();
      }
    },
    ...
    proposalVoters: {
      ...
      lookup(...args_0) {
        ...
        if (state.asArray()[1].asArray()[4].asMap().get({ value: _descriptor_2.toValue(key_0),
        ...
        return {
          ...
          [Symbol.iterator](...args_1) {
            ...
            const self_0 = state.asArray()[1].asArray()[4].asMap().get({ value: _descriptor_2.toValue(key_0),
                                                                         alignment: _descriptor_2.alignment() });
    ...
    crossProposalVoters: {
      ...
      lookup(...args_0) {
        ...
        if (state.asArray()[1].asArray()[6].asMap().get({ value: _descriptor_0.toValue(key_0),
        ...
        return {
          ...
          [Symbol.iterator](...args_1) {
            ...
            const self_0 = state.asArray()[1].asArray()[6].asMap().get({ value: _descriptor_0.toValue(key_0),
                                                                         alignment: _descriptor_0.alignment() });
