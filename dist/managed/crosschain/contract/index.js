...
const _descriptor_10 = new __compactRuntime.CompactTypeVector(29, _descriptor_4);

class _ClaimTokenInfo_0 {
  alignment() {
...
const _descriptor_11 = new _ClaimTokenInfo_0();
...
const _descriptor_24 = new __compactRuntime.CompactTypeEnum(7, 1);
...
const _descriptor_25 = new _FeeConfig_0();
...
const _descriptor_26 = new _Proposal_0();
...
export class Contract {
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(1n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_19.toValue({ smgId: new Uint8Array(32), fromAddr: { bytes: new Uint8Array(32) }, toAddr: '', tokenPairId: 0n, tokenAccount: new Uint8Array(32), amount: 0n, fee: 0n }),
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(6n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(feeReceiverInit_0),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_3 = 1n;
                                                                            ...
                                                                            path: [
                                                                                   ...
                                                                                   { tag: 'value',
                                                                                     value: { value: _descriptor_7.toValue(6n),
                                                                                              alignment: _descriptor_7.alignment() } },
                                                                                   { tag: 'value',
                                                                                     value: { value: _descriptor_1.toValue(tmp_7),
                                                                                              alignment: _descriptor_1.alignment() } }] } },
                                                                   { push: { storage: false,
                                                                             value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(voterIndex_0),
                                                                                                                          alignment: _descriptor_7.alignment() }).encode() } },
                   ...
                   isAdd_0)
  {
    ...
    const oldAmount_0 = _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                  partialProofData,
                                                                                  [
                                                                                   { dup: { n: 0 } },
                                                                                   { idx: { cached: false,
  ...
  __transfer_0(context,
               ...
               fee_0)
  {
    const tmp_0 = { receiver: toAddr_0,
                    token: token_0,
                    isMappingToken: false,
                    amount:
                      (__compactRuntime.assert(amount_0 >= fee_0,
                                               'result of subtraction would be negative'),
                       amount_0 - fee_0) };
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                   ...
                   ((context, partialProofData, t_0, uniqueId_0) =>
                    {
                                                                                                 ...
                                                                                                 result: undefined } }]).value)))
                      {
                        ...
                        const tmp_1 = { uniqueId: uniqueId_0,
  ...
  _userClaim_0(context, partialProofData, id_0) {
    ...
    const claimMappingTokenInfo_0 = _descriptor_11.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                               partialProofData,
                                                                                               [
                                                                                                { dup: { n: 0 } },
                                                                                                { idx: { cached: false,
  ...
  _checkAdminAuthorized_0(context, partialProofData) {
    const isOwner_0 = this._equal_16(_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                     ...
                                     this._ownPublicKey_0(context,
                                                          partialProofData));
    let t_0, tmp_1, tmp_0;
    const isAdminAuthorized_0 = (tmp_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                   partialProofData,
                                                                                                   [
                                                                                                    { dup: { n: 0 } },
                                                                                                    { idx: { cached: false,
                                 ...
                                 _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                           ...
                                                                                           [
                                                                                            ...
                                                                                            { popeq: { cached: true,
                                                                                                       result: undefined } }]).value))
                                &&
                                (t_0 = (tmp_1 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                          partialProofData,
                                                                                                          [
                                                                                                           { dup: { n: 0 } },
                                                                                                           { idx: { cached: false,
  ...
  return {
    ...
    proposals: {
      ...
      [Symbol.iterator](...args_0) {
        ...
        return self_0.asMap().keys().map(  (key) => {    const value = self_0.asMap().get(key).asCell();    return [      _descriptor_0.fromValue(key.value),      _descriptor_26.fromValue(value.value)    ];  })[Symbol.iterator]();
      }
    },
    ...
    proposalVoters: {
      ...
      lookup(...args_0) {
        ...
        if (state.asArray()[1].asArray()[4].asMap().get({ value: _descriptor_0.toValue(key_0),
        ...
        return {
          ...
          [Symbol.iterator](...args_1) {
            ...
            const self_0 = state.asArray()[1].asArray()[4].asMap().get({ value: _descriptor_0.toValue(key_0),
                                                                         alignment: _descriptor_0.alignment() });
    ...
    crossProposalVoters: {
      ...
      lookup(...args_0) {
        ...
        if (state.asArray()[1].asArray()[6].asMap().get({ value: _descriptor_1.toValue(key_0),
        ...
        return {
          ...
          [Symbol.iterator](...args_1) {
            ...
            const self_0 = state.asArray()[1].asArray()[6].asMap().get({ value: _descriptor_1.toValue(key_0),
                                                                         alignment: _descriptor_1.alignment() });
