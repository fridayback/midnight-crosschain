...
import { EncryptionSecretKey, decodeRawTokenType, encodeRawTokenType, createShieldedCoinInfo } from '@midnight-ntwrk/ledger-v7';
...
import { ContractState, encodeShieldedCoinInfo, encodeUserAddress, rawTokenType, sampleSigningKey } from '@midnight-ntwrk/compact-runtime';
