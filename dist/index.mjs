...
var _descriptor_14 = new _ExecuteCrossProposalInfo_0();
var _descriptor_15 = new __compactRuntime.CompactTypeVector(3, _descriptor_14);
...
var _descriptor_17 = new __compactRuntime.CompactTypeVector(5, _descriptor_16);
var _descriptor_18 = new __compactRuntime.CompactTypeUnsignedInteger(65535n, 2);
var _descriptor_19 = __compactRuntime.CompactTypeOpaqueString;
var _CrossOutBound_0 = class {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_4.alignment().concat(_descriptor_19.alignment().concat(_descriptor_0.alignment().concat(_descriptor_1.alignment().concat(_descriptor_2.alignment().concat(_descriptor_2.alignment()))))));
  }
  fromValue(value_0) {
    return {
      smgId: _descriptor_1.fromValue(value_0),
      fromAddr: _descriptor_4.fromValue(value_0),
      toAddr: _descriptor_19.fromValue(value_0),
      tokenPairId: _descriptor_0.fromValue(value_0),
...
var Contract = class {
    ...
    this.circuits = {
      userLock: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(smgId_0).concat(_descriptor_19.toValue(toAddr_0).concat(_descriptor_0.toValue(tokenPairId_0).concat(_descriptor_2.toValue(amount_0)))),
            alignment: _descriptor_1.alignment().concat(_descriptor_19.alignment().concat(_descriptor_0.alignment().concat(_descriptor_2.alignment())))
          },
          output: void 0,
          publicTranscript: [],
      ...
      executeMultiCrossProposal: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_15.toValue(mutiEx_0),
    ...
    __compactRuntime.queryLedgerState(
      ...
      [
        ...
        { push: {
          storage: true,
          value: __compactRuntime.StateValue.newCell({
            value: _descriptor_20.toValue({ smgId: new Uint8Array(32), fromAddr: { bytes: new Uint8Array(32) }, toAddr: "", tokenPairId: 0n, tokenAccount: new Uint8Array(32), amount: 0n, fee: 0n }),
    ...
    __compactRuntime.queryLedgerState(
      ...
      [
        ...
        { addi: { immediate: parseInt(__compactRuntime.valueToBigInt(
          {
            value: _descriptor_18.toValue(tmp_3),
  ...
  _userLock_0(context, partialProofData, smgId_0, toAddr_0, tokenPairId_0, amount_0) {
    ...
    this.__internal_receive_unshielded_0(
      tokenPair_0.midnigthTokenAccount,
      amount_0
    );
    if (contractFee_0 > 0n) {
      this.__internal_receive_unshielded_0(this._nativeToken_0(), contractFee_0);
    }
    const tmp_0 = {
      smgId: smgId_0,
  ...
  _userBurn_0(context, partialProofData, smgId_0, toAddr_0, tokenPairId_0, amount_0) {
    ...
    this.__internal_send_unshielded_0(
      tokenPair_0.midnigthTokenAccount,
      amount_0,
      this._right_0({ bytes: __compactRuntime.convertFieldToBytes(
        32,
        0n,
        "crosschain.compact line 227 char 134"
      ) })
    );
    const tmp_0 = {
      smgId: smgId_0,
    ...
    if (!(tmp_0 = this._ownPublicKey_0(context, partialProofData), _descriptor_5.fromValue(__compactRuntime.queryLedgerState(
      ...
      this._folder_0(
        ...
        ((context2, partialProofData2, t_0, target_0) => {
          let tmp_1;
          if (!this._equal_1(target_0.uniqueId, new Uint8Array(32)) && (tmp_1 = target_0.uniqueId, _descriptor_5.fromValue(__compactRuntime.queryLedgerState(
            context2,
            partialProofData2,
            [
              { dup: { n: 0 } },
    ...
    if (this._equal_4(newTotalSupply_0, 0n)) {
      ...
      const tmp_0 = ((t1) => {
        if (t1 > 340282366920938463463374607431768211455n) {
          throw new __compactRuntime.CompactError("crosschain.compact line 368 char 52: cast from Field or Uint value to smaller Uint value failed: " + t1 + " is greater than 340282366920938463463374607431768211455");
        }
        return t1;
      })(newTotalSupply_0);
      __compactRuntime.queryLedgerState(
  ...
  __internal_receive_unshielded_0(color_0, amount_0) {
    return [];
  }
  __internal_send_unshielded_0(color_0, amount_0, toAddr_0) {
    return [];
  }
  __interal_mint_unshielded_0(domainSep_0, amount_0, toAddr_0) {
    return [];
  }
  _executeCrossProposal_0(context, partialProofData, uniqueId_0, coinIndex_0) {
    ...
    if (proposal_0.isMappingToken === false) {
      ...
      let t_0, t_1;
      this.__interal_mint_unshielded_0(
        proposal_0.token,
        ((t1) => {
          if (t1 > 18446744073709551615n) {
            throw new __compactRuntime.CompactError("crosschain.compact line 395 char 46: cast from Field or Uint value to smaller Uint value failed: " + t1 + " is greater than 18446744073709551615");
          }
          return t1;
      ...
      if (proposal_0.fee > 0n) {
        this.__interal_mint_unshielded_0(
          proposal_0.token,
          ((t1) => {
            if (t1 > 18446744073709551615n) {
              throw new __compactRuntime.CompactError("crosschain.compact line 396 char 67: cast from Field or Uint value to smaller Uint value failed: " + t1 + " is greater than 18446744073709551615");
            }
            return t1;
          })(proposal_0.fee),
    ...
    this._folder_2(
      ...
      ((context2, partialProofData2, index_0, voter_0) => {
        ...
        if (!this._equal_7(voter_0, { bytes: new Uint8Array(32) })) {
          ...
          return ((t1) => {
            if (t1 > 255n) {
              throw new __compactRuntime.CompactError("crosschain.compact line 477 char 14: cast from Field or Uint value to smaller Uint value failed: " + t1 + " is greater than 255");
            }
            return t1;
          })(index_0 + 1n);
        } else {
  ...
  _checkAdminAuthorized_0(context, partialProofData) {
    ...
    return isOwner_0 && this._equal_9(
      _descriptor_7.fromValue(__compactRuntime.queryLedgerState(
        context,
        partialProofData,
        [
