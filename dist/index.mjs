...
var _descriptor_1 = new __compactRuntime.CompactTypeUnsignedInteger(340282366920938463463374607431768211455n, 16);
var _descriptor_2 = new __compactRuntime.CompactTypeUnsignedInteger(4294967295n, 4);
var _descriptor_3 = __compactRuntime.CompactTypeBoolean;
...
var _descriptor_5 = new __compactRuntime.CompactTypeUnsignedInteger(255n, 1);
var _descriptor_6 = new __compactRuntime.CompactTypeUnsignedInteger(18446744073709551615n, 8);
...
var _descriptor_13 = new __compactRuntime.CompactTypeVector(5, _descriptor_12);
...
var _descriptor_15 = __compactRuntime.CompactTypeOpaqueString;
...
var _descriptor_17 = new __compactRuntime.CompactTypeVector(2, _descriptor_0);
var _Either_0 = class {
  alignment() {
...
var _descriptor_20 = new __compactRuntime.CompactTypeUnsignedInteger(65535n, 2);
var _descriptor_21 = new __compactRuntime.CompactTypeEnum(7, 1);
...
var _descriptor_23 = new __compactRuntime.CompactTypeVector(29, _descriptor_10);
...
var Contract = class {
  ...
  _mintUnshieldedToken_0(context, partialProofData, domainSep_0, amount_0, recipient_0) {
    ...
    const color_0 = this._tokenType_0(
      domainSep_0,
      _descriptor_11.fromValue(__compactRuntime.queryLedgerState(
        context,
        partialProofData,
        [
          { dup: { n: 2 } },
  ...
  _addCrossProposal_0(context, partialProofData, uniqueId_0, smgId_0, tokenPairId_0, tokenPair_0, amount_0, toAddr_0, fee_0, ttl_0) {
    ...
    if (_descriptor_3.fromValue(__compactRuntime.queryLedgerState(
      context,
      partialProofData,
      [
        { dup: { n: 0 } },
      ...
      if (this._blockTimeLt_0(
        context,
        partialProofData,
        _descriptor_8.fromValue(__compactRuntime.queryLedgerState(
          context,
          partialProofData,
          [
            { dup: { n: 0 } },
      ...
      ) || (t_2 = _descriptor_6.fromValue(__compactRuntime.queryLedgerState(
        context,
        partialProofData,
        [
          { dup: { n: 0 } },
      ...
      ).value), t_2 >= _descriptor_5.fromValue(__compactRuntime.queryLedgerState(
        context,
        partialProofData,
        [
          { dup: { n: 0 } },
    ...
    let tmp_1;
    const voterIndex_0 = (tmp_1 = this._ownPublicKey_0(context, partialProofData), _descriptor_5.fromValue(__compactRuntime.queryLedgerState(
      context,
      partialProofData,
      [
        { dup: { n: 0 } },
  ...
  _voteMultiCrossProposal_0(context, partialProofData, uniqueIds_0) {
    let tmp_0;
    if (!(tmp_0 = this._ownPublicKey_0(context, partialProofData), _descriptor_3.fromValue(__compactRuntime.queryLedgerState(
      context,
      partialProofData,
      [
        { dup: { n: 0 } },
      ...
      this._folder_0(
        ...
        ((context2, partialProofData2, t_0, target_0) => {
          let tmp_1;
          if (!this._equal_7(target_0.uniqueId, new Uint8Array(32)) && (tmp_1 = target_0.uniqueId, _descriptor_3.fromValue(__compactRuntime.queryLedgerState(
            context2,
            partialProofData2,
            [
              { dup: { n: 0 } },
            ...
            let tmp_2;
            const proposal_0 = (tmp_2 = target_0.uniqueId, _descriptor_8.fromValue(__compactRuntime.queryLedgerState(
              context2,
              partialProofData2,
              [
                { dup: { n: 0 } },
            ...
            let t_1, tmp_3;
            if (t_1 = (tmp_3 = target_0.uniqueId, _descriptor_6.fromValue(__compactRuntime.queryLedgerState(
              context2,
              partialProofData2,
              [
                { dup: { n: 0 } },
            ...
            ).value)), t_1 < _descriptor_5.fromValue(__compactRuntime.queryLedgerState(
              context2,
              partialProofData2,
              [
                { dup: { n: 0 } },
  ...
  _updateReserve_0(context, partialProofData, isMappingToken_0, token_0, delta_0, isAdd_0) {
    ...
    const oldAmount_0 = _descriptor_3.fromValue(__compactRuntime.queryLedgerState(
      context,
      partialProofData,
      [
        { dup: { n: 0 } },
    ...
    ).value) ? _descriptor_14.fromValue(__compactRuntime.queryLedgerState(
      context,
      partialProofData,
      [
        { dup: { n: 0 } },
    ...
    __compactRuntime.assert(
      this._equal_9(oldAmount_0, 0n) || _descriptor_14.fromValue(__compactRuntime.queryLedgerState(
        context,
        partialProofData,
        [
          { dup: { n: 0 } },
  ...
  __transfer_0(context, partialProofData, uniqueId_0, token_0, toAddr_0, amount_0, fee_0) {
    if (fee_0 > 0n) {
      this._sendUnshielded_0(
        ...
        token_0,
        fee_0,
        this._right_0(_descriptor_7.fromValue(__compactRuntime.queryLedgerState(
          context,
          partialProofData,
          [
            { dup: { n: 0 } },
  ...
  _executeCrossProposal_0(context, partialProofData, uniqueId_0) {
    ...
    let t_0;
    __compactRuntime.assert(
      (t_0 = _descriptor_6.fromValue(__compactRuntime.queryLedgerState(
        context,
        partialProofData,
        [
          { dup: { n: 0 } },
      ...
      ).value), t_0 >= _descriptor_5.fromValue(__compactRuntime.queryLedgerState(
        context,
        partialProofData,
        [
          { dup: { n: 0 } },
    ...
    const proposal_0 = _descriptor_8.fromValue(__compactRuntime.queryLedgerState(
      context,
      partialProofData,
      [
        { dup: { n: 0 } },
    ...
    if (proposal_0.isMappingToken === false) {
      ...
      let tmp_1;
      (tmp_1 = proposal_0.tokenPairId, _descriptor_4.fromValue(__compactRuntime.queryLedgerState(
        context,
        partialProofData,
        [
          { dup: { n: 0 } },
  ...
  _updateTokenTotalSupply_0(context, partialProofData, token_0, delta_0, isAdd_0) {
    __compactRuntime.assert(delta_0 > 0n, "delta must be positive");
    const oldTotalSupply_0 = _descriptor_3.fromValue(__compactRuntime.queryLedgerState(
      context,
      partialProofData,
      [
        { dup: { n: 0 } },
  ...
  _getFee_0(context, partialProofData, tokenPairId_0) {
    ...
    if (this._equal_12(tokenPair_0.fee, 0n)) {
      let tmp_0;
      if (tmp_0 = tokenPair_0.toChainId, _descriptor_3.fromValue(__compactRuntime.queryLedgerState(
        context,
        partialProofData,
        [
          { dup: { n: 0 } },
...
function ledger2(stateOrChargedState) {
  ...
  return {
    ...
    get currentExecuteCrossProposal() {
      return _descriptor_9.fromValue(__compactRuntime.queryLedgerState(
        context,
        partialProofData,
        [
          { dup: { n: 0 } },
    ...
    proposals: {
      ...
      lookup(...args_0) {
        ...
        return _descriptor_24.fromValue(__compactRuntime.queryLedgerState(
          context,
          partialProofData,
          [
            { dup: { n: 0 } },
  ...
  async getUnVotedCrossProposal(ledger3, voter) {
    ...
    for (const [uniqueId, _] of ledger3.crossProposal) {
      ...
      if (voters.member(voterIndex)) continue;
        ...
        const crossTxInfo = _CrossChainApi.getCrossTxInfo(ledger3, toHex(uniqueId));
